...
const createOrder = async (req, res) => {
    ...
    try {
        ...
        sendSuccess(res, newOrder[0], 'Order created successfully', 201);
...
const updateOrder = async (req, res) => {
    ...
    try {
        ...
        log.success(`Order updated successfully`, { orderId: id, itemCount: items.length });

        sendSuccess(res, updatedOrder[0], 'Order updated successfully');
...
const completeOrder = async (req, res) => {
    ...
    try {
        ...
        sendSuccess(res, { order_id: id, change: change_amount }, 'Order completed successfully');
...
const cancelOrder = async (req, res) => {
    ...
    try {
        ...
        log.success(`Order cancelled: ${order.order_number}`, { orderId: id });
